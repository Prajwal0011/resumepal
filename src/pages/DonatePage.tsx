...
import { ArrowLeft, Heart, Check, Copy, Building2, Users, Server, Code, Coffee } from 'lucide-react';
              ...
              <div className="p-4">
                <div>
                  <div className="bg-blue-50 rounded-xl p-3 mb-3">
                    <img
                      src="./qr-code.png"
                      alt="Global IME Bank QR Code - Scan to Pay"
                  ...
                  <div className="text-center">
                    ...
                    {copied === 'bank' && <p className="text-green-600 text-xs mt-1">Copied account number!</p>}
                  </div>
                  <div className="mt-3 bg-blue-50 rounded-lg p-3">
                    <p className="text-blue-800 text-xs font-bold mb-1.5">🏦 Bank Transfer Help:</p>
                    <ol className="text-blue-700 text-[11px] space-y-0.5">
                      <li>1. Open your banking app.</li>
                      <li>2. Scan the QR code or enter the account number manually.</li>
                      <li>3. Enter the amount and confirm the transfer.</li>
                    </ol>
                    <p className="text-blue-700 text-[11px] mt-2 leading-relaxed">
                      If the QR does not work, you can directly transfer to the account number above.
                      If you really want to donate but need more account details, email me at
                      <a href="mailto:sewacircle123@gmail.com" className="font-bold underline ml-1">sewacircle123@gmail.com</a>.
                    </p>
                  </div>
                </div>
              </div>
