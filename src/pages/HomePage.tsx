...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 no-horizontal-scroll">
      {/* Hero */}
      <section className="bg-gray-900 text-white py-16 sm:py-20 px-4 sm:px-6 overflow-hidden">
        <div className="max-w-6xl mx-auto text-center min-w-0">
          <motion.div className="min-w-0" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <div className="inline-flex max-w-full items-center justify-center gap-2 bg-white/10 border border-white/20 rounded-full px-3 sm:px-4 py-1.5 text-xs sm:text-sm mb-6">
              <Sparkles size={14} className="text-amber-400 flex-shrink-0" />
              <span className="truncate sm:whitespace-normal">Free Resume Builder - No Sign Up Required</span>
            </div>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight mb-6 break-words leading-tight">
              Build Your <span className="text-amber-400">Perfect Resume</span>
            </h1>
            <p className="text-gray-400 text-base sm:text-lg max-w-2xl mx-auto mb-10 px-1">
      ...
      {/* Templates Gallery */}
      <section id="templates" className="py-20 px-4 sm:px-6 bg-gray-50 overflow-hidden">
        <div className="max-w-6xl mx-auto min-w-0">
          <div className="text-center mb-14">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 min-w-0">
            {templates.map((template, i) => {
              ...
              return (
                ...
                >
                  <div className="bg-white rounded-xl overflow-hidden border border-gray-200 hover:shadow-xl transition-all hover:-translate-y-1 min-w-0">
                    <div className="h-64 overflow-hidden bg-gray-100 relative">
                      <div className="absolute left-0 top-0 w-[800px] scale-[0.35] origin-top-left pointer-events-none">
      ...
      {/* CTA */}
      <section className="py-20 px-4 sm:px-6 bg-gray-900 text-white overflow-hidden">
      ...
      {/* Donation CTA */}
      <section className="py-16 px-4 sm:px-6 bg-amber-50 overflow-hidden">
        <div className="max-w-3xl mx-auto text-center min-w-0">
